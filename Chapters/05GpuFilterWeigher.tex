...
auf physischer Hardware wäre mit entsprechendem Aufwand und Kosten verbunden und erschwert den
...
Zur Anforderung von 2 GPUs setzen wir den Extra Spec resources:CUSTOM\_GPU=2.
