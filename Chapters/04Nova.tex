...
die gemeinsame Eigenschaften besitzen. Ein negatives Gewicht führt dabei zu einem
...
Ein Zugriff auf das Attribut \textbf{customscope:someattribute} ist Beispielsweise so möglich:
